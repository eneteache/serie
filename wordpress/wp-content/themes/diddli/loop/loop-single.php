...
<?php /////////MASTHEMS//////// ?>
<div class="col-md-7 ladodos">
	<div class="row">
		<div id="bacmovt" class="background-pelicula" style="background-image:url(<?php image_show($backdrop_path, "url", "w500"); ?>)">
	...
	<div class="tab-content taballc">
		<div id="enlaces" class="tab-pane active">
			<h2><?php _e('Sinopsis', 'masthemes'); ?></h2>
