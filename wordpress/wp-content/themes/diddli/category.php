	...
	<div class="container">
    	<div class="row">
            <section class="showpeliculas col-mt-8">
				<h1><?php _e('movies of', 'masthemes'); ?> <?php echo single_cat_title("", false); ?></h1>
				<span class="subth3"><?php _e('Find all movies, tv shows and documentaries of', 'masthemes'); ?> <?php echo single_cat_title("", false); ?>.</span>
